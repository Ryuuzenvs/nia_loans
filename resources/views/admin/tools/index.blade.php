...
@section('content')
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold text-dark">Dashboard Buku</h2>
                <p class="text-muted small mb-0">Pantau Buku</p>
            </div>
            ...
            <div class="col-md-7">
                <form method="GET" action="{{ route('tools.index') }}" class="d-flex gap-2">
                    <div class="input-group shadow-sm" style="max-width: 350px;">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" class="form-control border-0 px-2"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <form action="{{ route('tools.destroy', $t->id) }}" method="POST"
